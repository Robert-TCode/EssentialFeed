...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWithResult result: RemoteFeedLoader.FeedResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
