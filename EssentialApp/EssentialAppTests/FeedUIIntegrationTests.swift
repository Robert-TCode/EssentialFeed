...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadMoreActions_requestMoreFromLoader() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 2, "Expected second request after load more completed with more pages")

        loader.completeLoadMoreWithError(at: 1)
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 3, "Expected third request after load more with failure")

        loader.completeLoadMore(lastPage: true, at: 2)
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 3, "Expected no request after load more completed with no more pages")
    }
    ...
    func test_loadingMoreIndicator_isVisibleWhileLoadingMore() {
        ...
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no loading indicator on load more successful completion")

        sut.simulateLoadMoreFeedAction()
        XCTAssertTrue(sut.isShowingLoadMoreFeedIndicator, "Expected loading indicator on second load more action")

        loader.completeLoadMoreWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no loading indicator on load more failure completion")
    }
    ...
    func test_loadMoreCompletion_rendersErrorMessageOnError() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(sut.loadMoreFeedErorMessage, nil)

        loader.completeLoadMoreWithError()
        XCTAssertEqual(sut.loadMoreFeedErorMessage, loadError)
