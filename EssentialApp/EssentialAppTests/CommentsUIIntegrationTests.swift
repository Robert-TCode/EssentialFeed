...
class CommentsUIIntegrationTests: XCTestCase   {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        sut.loadViewIfNeeded()
        XCTAssertEqual(loader.loadCommentsCount, 1, "Expected a loading requests once view is loaded")

        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCount, 2, "Expected another loading requests once user initiates a load")

        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCount, 3, "Expected a third loading requests once user initiates another load")
    }
